...
#
#   scripts/setup/fetch_kinetics.sh                 # archived copy (requester pays)
#   scripts/setup/fetch_kinetics.sh --verify-only   # just check an existing copy
#   scripts/setup/fetch_kinetics.sh --subset 6500   # 10%, enough for --scale small
#
